...
- Реализовал смену цвета окна вывода результата по кнопке.
- Реализовал смену цвета фона по кнопке;
...
- Запрограммировал накапливаемое деление;
- Запрограммировал накапливаемое произведение;


### Задание с практики
- Реализовать вывод знака '.' таким образом, чтобы он отображался корректно и в нужном месте;
- Реализовать окно вывода таким образом, чтобы значения не выходили за его границы.
